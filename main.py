...
# формируем полную дату и конструируем календарные признаки
...
# лаги с 3го месяца с шагом в 7 дней для сохранения дневного профиля
...
# функция подгрузки обученной модели
...
# фильтрация контрольной выборки и прогноз
...
if __name__ == '__main__':
    ...
    test_result = filter_and_predict(test_df, model_rf)
    result = test_result.groupby('date', as_index=False).agg({'predict': 'sum'})
